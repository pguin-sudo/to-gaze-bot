...
from to_gaze_bot import handlers, utils, web_handlers
from to_gaze_bot.data import config
from to_gaze_bot.middlewares import StructLoggingMiddleware
    ...
    dp = Dispatcher(
        storage=RedisStorage(
            redis=Redis(
                ...
                username=config.FSM_USER,
                password=config.FSM_USER_PASSWORD,
                db=0,
            ),
